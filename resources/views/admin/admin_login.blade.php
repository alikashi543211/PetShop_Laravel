                    ...
                    <div class="panel-body">
                        <form action="{{route('admin')}}" id="loginForm" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="example@gmail.com" title="Please enter you username" required="" value="{{old('username')}}" name="username" id="username" class="form-control">
