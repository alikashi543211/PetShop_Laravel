 ...
 <!-- Content Wrapper. Contains page content -->
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-10" method="POST" action="{{route('role.store')}}" enctype="multipart/form-data">
                           	@csrf
                              <div class="form-group">
                                 <label>Role Name</label>
                                 <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter role Name" name="name" id="name" required>
                              </div>
                              <div class="row">
            <div class="col-lg-4">
      ...
      @foreach($permissions as $permission)
           @if($permission->for=='user')
            ...
            <p><input name="permission[]" value="{{ $permission->id }}" type="checkbox">  {{ $permission->name }}</p>
