                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" method="POST" action="{{route('category.store')}}" enctype="multipart/form-data">
                           	@csrf
                              <div class="form-group">
                                 <label>Category Name</label>
                                 <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Category Name" name="name" id="name" required>
                              </div>
                              <div class="form-group">
